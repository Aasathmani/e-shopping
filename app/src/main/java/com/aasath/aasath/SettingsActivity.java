...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileImageView = (ImageView) findViewById(R.id.setting_profile_image);
    ...
    private void UserInfoDisplay(ImageView profileImageView, EditText fullNameEditText, EditText userPhoneEditText, EditText addressEditText)
    {
