...
import com.aasath.aasath.Model.Cart;
import com.aasath.aasath.Prevelent.Prevelent;
import com.aasath.aasath.ViewHolder.CartViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
...

        {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent=new Intent(CartActivity.this,ConfirmFianlOrderActivity.class);
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder>adapter=
                new FirebaseRecyclerAdapter<Cart, CartViewHolder >(options) {
                    ...
                    protected void onBindViewHolder(@NonNull CartViewHolder cartViewHolder, int i, @NonNull Cart model) {
                        cartViewHolder.txtProductQuantity.setText("Quentity = "+model.getQuantity());
